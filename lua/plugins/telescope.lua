return {
    {
        ...
        keys = function()
            ...
            return {
                ...
                { "<m-f>", builtin.lsp_dynamic_workspace_symbols, desc = "All workspace symbol picker" },
                { "<leader>fo", builtin.treesitter, desc = "File symbol picker" },
                { "<m-o>", builtin.treesitter, desc = "File symbol picker" },
                { "<leader>fp", builtin.diagnostics, desc = "Diagnostics" },
                { "<m-p>", builtin.diagnostics, desc = "Diagnostics" },
                { "<leader>fj", builtin.jumplist, desc = "Jump list" },
                { "<leader>fm", builtin.colorscheme, desc = "Colorscheme" },
                { "<c-k>m", builtin.colorscheme, desc = "Colorscheme" },
